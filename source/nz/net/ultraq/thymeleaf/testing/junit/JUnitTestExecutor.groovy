...
abstract class JUnitTestExecutor {
	 ...
	 * definition of stream can be found on their docs for
	 * <a href="https://junit.org/junit5/docs/current/user-guide/#writing-tests-parameterized-tests-sources-MethodSource"
	 * target="_top">@MethodSource</a>.
	 */
